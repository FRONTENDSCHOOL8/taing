  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        selectProfile: resolve(
          __dirname,
          '/src/pages/selectProfile/index.html'
        ),
        ...
        userMenuModal: resolve(
          __dirname,
          '/src/pages/modal/userMenuModal/index.html'
        ),
        withdrawalModal: resolve(
          __dirname,
          '/src/pages/modal/withdrawalModal/index.html'
        ),
      },
    },
  },
